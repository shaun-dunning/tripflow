    ...
    <div className="flex flex-col gap-5 pb-6">
      ...
      <div>
        ...
        <div className="relative h-56 w-full overflow-hidden">
          ...
          {/* Countdown pill */}
          <div className="absolute right-4 bg-white/20 backdrop-blur-md border border-white/30 text-white rounded-2xl px-3 py-2 text-center" style={{ top: "max(16px, env(safe-area-inset-top))" }}>
