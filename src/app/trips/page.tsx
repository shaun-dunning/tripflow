    ...
    <div className="flex flex-col pb-6 gap-5">
      ...
      <div>
        ...
        <div className="relative h-56 w-full overflow-hidden">
          ...
          {/* Countdown pill */}
          <div className="absolute right-4 bg-white/20 backdrop-blur-md border border-white/30 text-white rounded-2xl px-3 py-1.5 text-center min-w-[56px]" style={{ top: "clamp(12px, env(safe-area-inset-top), 44px)" }}>
            {isComplete ? (
